By adding Security Onion to monitor traffic within my network, Suricata detected multiple SSH brute‑force attempts originating from a single internal IP address. . This alert was a true positive.
